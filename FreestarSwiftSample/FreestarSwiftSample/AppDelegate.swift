...
//        Freestar.setServingMode(.admobGam)
        ...
        //NOTE: Confiant should be initialized BEFORE making any request for Ads
        ConfiantTest.confiantInitialize(with: "Vw6Hmt4tR8gdJgdE_ZvL9fmbqdE") { initializedOk in
            if initializedOk {
                ...
                assertionFailure("Confiant Not Initialized")
            }
        }
